...
class TestModelBuilder(unittest.TestCase):
    """Test suite for model builder interface"""
    ...
    def test_model_builder2(self):  # pylint: disable=R0915
        """FIXME: Please use gallery function!"""
    ...
    def test_model_builder3(self):  # pylint: disable=R0914
