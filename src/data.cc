...
TypeInfo DenseDMatrix::GetElementType() const {
...
template <typename ElementType>
DMatrixType DenseDMatrixImpl<ElementType>::GetType() const {
...
TypeInfo CSRDMatrix::GetElementType() const {
  return element_type_;
}
...
template <typename ElementType>
DMatrixType CSRDMatrixImpl<ElementType>::GetType() const {
