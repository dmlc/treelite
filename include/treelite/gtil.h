...
/*!
 * \brief Query the correct amount of buffer to allocate for the prediction output.
 * \param model The model object
 * \param num_row number of rows in the input.
 * \return Size of the buffer to be allocated.
 */
std::size_t GetPredictOutputSize(const Model* model, std::size_t num_row);
/*!
 * \brief Query the correct amount of buffer to allocate for the prediction output.
 * \param model The model object
 * \param input The data matrix used as the input
 * \return Size of the buffer to be allocated.
 */
