...
class SKLConverterBase:
    ...
    @classmethod
    def process_tree(cls, sklearn_tree, sklearn_model, *args):
        ...
        for node_id in range(sklearn_tree.node_count):
            cls.process_node(treelite_tree, sklearn_tree, node_id, sklearn_model, *args)
    ...
    @classmethod
    def process_node(cls, treelite_tree, sklearn_tree, node_id, sklearn_model, *args):
        ...
        if sklearn_tree.children_left[node_id] == -1:  # leaf node
            cls.process_leaf_node(treelite_tree, sklearn_tree, node_id, sklearn_model, *args)
        else:  # test node
            cls.process_test_node(treelite_tree, sklearn_tree, node_id, sklearn_model, *args)

    @classmethod
    def process_test_node(cls, treelite_tree, sklearn_tree, node_id, sklearn_model, *args):
    ...
    @classmethod
    def process_leaf_node(cls, treelite_tree, sklearn_tree, node_id, sklearn_model, *args):
