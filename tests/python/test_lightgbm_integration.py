...
class TestLightGBMIntegration(unittest.TestCase):
    """Test suite for integrating with LightGBM"""
    def test_lightgbm_multiclass_classification(self):  # pylint: disable=R0914
    ...
    def test_lightgbm_binary_classification(self):  # pylint: disable=R0914
