...
params = {'objective': 'rank:ndcg', 'eta': 0.01, 'gamma': 1.0,
          'min_child_weight': 0.1, 'max_depth': 8, 'silent': 1, 'eval_metric':'ndcg'}
# num_boost_round=713 was chosen using early stopping on validation set mq2008.vali
xgb_model = xgboost.train(params, dtrain, num_boost_round=713,
